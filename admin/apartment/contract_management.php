                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr onclick="viewContractDetail('<?php echo $contract['ContractCode']; ?>')" style="cursor: pointer;">
                                ...
                                <?php if (isset($contract['File']) && !empty($contract['File'])): ?>
                                    <?php
                                        $filePath = $contract['File']; 
                                        
                                        $basePath = 'C:/xampp/htdocs/webquanlytoanha/'; 
                                        $urlPath = str_replace($basePath, '/', $filePath);
                                        $baseUrl = 'http://localhost/webquanlytoanha';
                                        $downloadUrl = $baseUrl . $urlPath;
                                    ?>
                                    <td>
                                        <a href="<?php echo $downloadUrl; ?>" download class="btn btn-primary">Tải về</a>
                                    </td>
                                <?php else: ?>
                                    <td>Không có file</td>
                                <?php endif; ?>
